...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 left-1/2 transform -translate-x-[calc(50%+50px)] items-center justify-center md:max-w-[420px]",
      className
    )}
    {...props}
  />
