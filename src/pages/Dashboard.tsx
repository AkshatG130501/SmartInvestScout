...
const suggestedTopics = [
  ...
  { id: 'green-energy', label: 'Green Energy', icon: <Leaf className="w-4 h-4" /> },
  { id: 'interest-rates', label: 'Interest Rates', icon: <DollarSign className="w-4 h-4" /> },
];

const recentSearches: SearchHistoryItem[] = [
  { id: '1', query: 'TSLA earnings forecast', timestamp: new Date('2024-03-10T10:30:00') },
  { id: '2', query: 'AI in Healthcare trends', timestamp: new Date('2024-03-09T15:45:00') },
  { id: '3', query: 'Bitcoin market analysis', timestamp: new Date('2024-03-08T09:20:00') },
];
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Get instant answers to your investment questions</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Analyze earnings reports and financial documents</p>
                  </div>
                </div>
            ...
            <div className="flex flex-wrap gap-3">
              {suggestedTopics.map((topic) => (
                <motion.button
                  ...
                  onClick={() => navigate(`/search/${encodeURIComponent(topic.label)}`)}
                >
                  {topic.icon}
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-3">
              {recentSearches.map((search) => (
                ...
                >
                  <span className="text-gray-700 group-hover:text-indigo-600">{search.query}</span>
