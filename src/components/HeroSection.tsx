        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 md:pr-8">
              Ask questions. Get instant insights. Stay ahead of the market with AI-powered investment research.
            </p>
          ...
          >
            <div className="relative bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl shadow-lg p-6 md:p-8 overflow-hidden h-full">
              ...
              <div className="relative z-10 bg-white/80 backdrop-blur-sm rounded-xl shadow-sm p-4 mb-4">
                <div className="flex items-center space-x-2 mb-3">
                  <div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center">
                    <TrendingUp className="h-4 w-4 text-indigo-600" />
                  </div>
                  <h3 className="font-semibold text-gray-800">TSLA Market Insight</h3>
                </div>
